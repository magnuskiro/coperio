...
var Event = new Class({
	...
	initialize: function(event){
		...
		if ( this.target && this.target.nodeType == 3) this.target = this.target.parentNode; // 1111111111111111111111111111111changes for the ie error changed from if ( this.target.nodeType == 3) this.target = this.target.parentNode;  to if ( this.target && this.target.nodeType == 3) this.target = this.target.parentNode; 
