...
{
$html = '<link href="templates/'.$this->_tpl->template.'/at_menu/at_menu/at-sosdmenu.css" rel="stylesheet" type="text/css" />
<script language="javascript" type="text/javascript" src="templates/'.$this->_tpl->template.'/scripts/mootools.js"></script>
<script language="javascript" type="text/javascript" src="templates/'.$this->_tpl->template.'/scripts/at.menu.js"></script>';
}
